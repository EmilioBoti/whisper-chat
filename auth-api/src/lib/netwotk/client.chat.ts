...
export const createProfile = async (id: string, name: string, email: string): Promise<SimpleProfile> => {
  return await service.request<SimpleProfile>('/user/create-profile', {
    method: 'POST',
